...
export function Model({ color, ...props }) {
  const { nodes, materials } = useGLTF('/model/datsun-transformed.glb');
  return (
    <group {...props} dispose={null}>
      ...
      <mesh castShadow receiveShadow geometry={nodes.Cylinder007_alloy_0_10.geometry}>
        <meshPhysicalMaterial color={color} metalness={1} roughness={0.5} clearcoat={1} clearcoatRoughness={0.2} />
      </mesh>
...
useGLTF.preload('/model/datsun-transformed.glb');
